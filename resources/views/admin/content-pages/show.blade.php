                                        ...
                                        @else
                                            <div class="alert alert-light-warning d-flex align-items-center p-5">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <h5 class="mb-1">No Translation Available</h5>
                                                    <span>This page has not been translated to {{ $name }} yet.</span>
                                                </div>
                                            </div>
                                        @endif
                                    </div>
                ...
                <div class="col-lg-4">
                    <div class="card shadow-sm mb-5">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-5">
                                <label class="form-label text-muted">Available Languages</label>
                            ...
                            <div class="text-muted fs-7">
                                ...
                                @if($page->created_by)
                                    <div class="mb-2">
                                        <strong>Created By:</strong> {{ $page->created_by }}
                                    </div>
                                @endif
                                @if($page->updated_by)
                                    <div class="mb-2">
                                        <strong>Updated By:</strong> {{ $page->updated_by }}
                                    </div>
                                @endif
                            </div>
                        </div>
